...
Me enfoco en construir sistemas robustos, optimizar flujos de información y desarrollar aplicaciones que resuelvan problemas reales.
...
### 📚 BookVerse – Biblioteca Virtual
**React | Supabase | CSS**

Participé en el diseño y administración de la base de datos en Supabase, asegurando la integridad de los registros y optimizando consultas para el consumo de la API desde el frontend en React.

### 🍔 ClickFood
**Ingeniería de Datos | Backend | Analítica Predictiva**
